...
export default function Screen2() {
  ...
  return (
    ...
    <Snackbar
      ...
      <RadioButton.Item label="Mountain" value="first" />
      <RadioButton.Item label="Cross Country" value="second" />
      <RadioButton.Item label="Sea Side" value="third" />
      <RadioButton.Item label="Savanna" value="second" />
    </RadioButton.Group>
      </View>
      <Divider />
    ...
    />
      ...
      <SegmentedButtons
        ...
        buttons={[
          ...
          { value: 'drive', label: 'BMX' },
        ]}
      />
      </View>
      <Divider />
      <Text style={styles.text}>Bike park</Text>
      <View style={styles.containers1}>
